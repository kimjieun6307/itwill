...
# &&& 1
# Oracle 이미 설치해서 실습했기 때문에 기존에 쓰던 scott/tiger 계정 사용
...
############ Oracle 11g ##############
# driver  object
# JDBC 함수 : JAVA와 DATADASE 연결(connect)한다.
drv<-JDBC("oracle.jdbc.driver.OracleDriver", 
          "C:/oraclexe/app/oracle/product/11.2.0/server/jdbc/lib/ojdbc6.jar")
# &&& 3

# dbConnect : db연동(driver, url,uid,upwd)  object 
...
# 4. table drop
dbSendUpdate(conn, "drop table db_test")
...
# 문1) SAL 2500이상이고, 직책(JOB)DL MANAGER인 사원만 검색하기
